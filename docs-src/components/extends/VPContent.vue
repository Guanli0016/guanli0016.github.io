...
<template>
	<div class="VPContent" id="VPContent" :class="{
		...
		<div class="starlayer1"></div>
		<div class="starlayer2"></div>
		<div class="starlayer3"></div>
		<div class="starlayer4"></div>
		<div class="starlayer5"></div>
...
@function getShadows( $n ) {
	$shadow: '#{ random(100) }vw #{ random(100) }vh #515151';
	@for $i from 2 through $n {
		$shadow: '#{ $shadow }, #{ random(100) }vw #{ random(100) }vh #515151';
	}
